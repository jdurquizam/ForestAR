...
# 6. Generate the IVI component plot
ggplot(ivi_plot_data, aes(x = reorder(Scientific_Name, IVI), y = Percentage, fill = Metric)) +
  geom_bar(stat = "identity", color = "black", linewidth = 0.2) +
  coord_flip() + # Horizontal bars are much easier to read for species names
  scale_fill_manual(values = c("Relative Density" = "#440154", 
  ...
  theme_classic() +
  theme(
    axis.text.y = element_text(face = "italic", size = 11), # Italicize scientific names
